...
(function () {
    ...
    ItemCreateCtrl.$inject = ['Item', 'AlertNotification', '$state', 'Authentication']; //, 'leafletEvents', 'ngDialog'];

    /**
     * @namespace ItemCreateCtrl
     */
    function ItemCreateCtrl(Item, AlertNotification, $state, Authentication){ //, leafletEvents, ngDialog) {
        var vm = this;
...
//            }
        ...
        function submit(){
            ...
            vm.promiseRequest = Item.create(vm.item, vm.images).then(createSuccess, createError);
